...
class MovieCreditsAndInfoWidget extends StatefulWidget {
  const MovieCreditsAndInfoWidget({
    super.key,
  ...
  @override
  State<MovieCreditsAndInfoWidget> createState() =>
      _MovieCreditsAndInfoWidgetState();
}

class _MovieCreditsAndInfoWidgetState extends State<MovieCreditsAndInfoWidget> {
  ...
  Widget build(BuildContext context) {
    return MovieCreditsAndInfoInterface(
      cst: cast,
      crw: crew,
      revws: reviews,
      imgs: images,
...
class MovieCreditsAndInfoInterface extends StatelessWidget {
  const MovieCreditsAndInfoInterface({
    super.key,
    required this.cst,
    required this.crw,
    required this.revws,
